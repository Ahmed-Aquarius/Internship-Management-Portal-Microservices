package com.example.internship_service.client;
...
@FeignClient(name = "user-service", url = "http://localhost:8087", configuration = com.example.internship_service.config.FeignConfig.class)
